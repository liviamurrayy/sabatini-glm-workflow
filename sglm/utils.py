...
def create_config(project_name, project_dir):
    ...
    glm_params = {
        ...
        'predictors': [
            ...
            'Cons_more_UR_R',
            'Cons_more_UR_L',
            'Cons_more_switchUR_R',
            'Cons_more_switchUR_L'
        ],
        'predictors_shift_bounds_default': [-50, 75],
        'predictors_shift_bounds': {
            ...
            'enl1750': [-89, 0],
            'enl2000': [-102, 0],
            'Consumption_R_R': [-50, 75],
            'Consumption_UR_R': [-50, 75],
            'Consumption_R_L': [-50, 75],
            'Consumption_UR_L': [-50, 75],
            'Cons_more_R_R': [-50, 75],
            'Cons_more_R_L': [-50, 75],
            'Cons_more_UR_R': [-50, 75],
            'Cons_more_UR_L': [-50, 75],
            'Cons_more_switchUR_R': [-50, 75],
            'Cons_more_switchUR_L': [-50, 75],
        },
        'response': 'z_grnR',
        'type': 'Normal',
        'glm_keyword_args': {
            'alpha': 0.0025,
            'l1_ratio': 0.05, #or list if using elasticnetcv
            'fit_intercept': True,
            'max_iter': 1000,            
            'warm_start': False,
